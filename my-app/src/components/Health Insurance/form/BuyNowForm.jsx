...
import ReviewDetailsCard from "../form/ReviewDetailsCard";
  ...
  return (
    <div className="min-h-screen bg-[#f3f3f3] px-3 py-4">
      <div className="mx-auto w-full max-w-[380px] overflow-hidden border border-[#cfcfcf] bg-[#f3f3f3]">
          ...
          <div className="flex items-start justify-between">
            <div className="flex gap-2">
              ...
              <div>
                ...
                <p className="mt-1 text-[9px] text-[#4a4a4a]">
        ...
        {steps === 2 && (
          <div className="px-3 py-3">
            ...
            >
              ...
              <p className="text-[6px] text-[#8a8a8a]">
                Same as on CNIC/Passport
              </p>

              <div className="grid grid-cols-2 gap-2">
                <select className="h-[20px] w-full border border-[#bdbdbd] bg-transparent px-2 text-[8px] text-[#6f6f6f] outline-none">
        ...
        {steps === 4 && (
          <PaymentDetailsCard onBack={() => setSteps(3)} />
        )}
      </div>
    </div>
  );
